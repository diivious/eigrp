...
phase "stage 2: configure and verify applicable Step-1 named IPv6/4453 commands"
# IPv6 runtime is intentionally incomplete, but the configuration must be
# accepted and retained.  IPv4-only network/classful/IPv4-summary syntax is
# not applied to the IPv6 address family.
...
set_topology_expect "$uut_name" ipv6 4453 "default-information in"
...
set_topology_expect "$uut_name" ipv6 4453 "maximum-prefix 1001"
set_af_expect "$uut_name" ipv6 4453 "metric weights 0 2 0 2 0 0"
set_topology_expect "$uut_name" ipv6 4453 "redistribute connected metric 11000 110 254 2 1492"
...
config="$(show_run)"
assert_af_line_absent_in "$config" "$uut_name" ipv6 4453 "metric weights 0 2 0 2 0 0"
set_if_expect "$uut_name" ipv6 4453 "$uut_if" "bandwidth 260000"
config="$(show_run)"
assert_mode_line_absent_in "$config" "$uut_name" ipv6 4453 "af-interface $uut_if" "exit-af-interface" "bandwidth 210000"
set_if_expect "$uut_name" ipv6 4453 "$uut_if" "delay 260"
config="$(show_run)"
assert_mode_line_absent_in "$config" "$uut_name" ipv6 4453 "af-interface $uut_if" "exit-af-interface" "delay 210"
set_topology_expect "$uut_name" ipv6 4453 "timers active-time 241"
config="$(show_run)"
assert_mode_line_absent_in "$config" "$uut_name" ipv6 4453 "topology base" "exit-af-topology" "timers active-time 181"
...
remove_if_expect "$uut_name" ipv6 4453 default "no bandwidth" "bandwidth 110000"
remove_if_expect "$uut_name" ipv6 4453 default "no delay" "delay 110"
remove_if_expect "$uut_name" ipv6 4453 default "no bandwidth-percent" "bandwidth-percent 61"
remove_if_expect "$uut_name" ipv6 4453 "$uut_if" "no bandwidth 260000" "bandwidth 260000"
remove_if_expect "$uut_name" ipv6 4453 "$uut_if" "no delay 260" "delay 260"
remove_if_expect "$uut_name" ipv6 4453 "$uut_if" "no bandwidth-percent" "bandwidth-percent 76"
remove_if_expect "$uut_name" ipv6 4453 "$uut_if" "no hello-interval" "hello-interval 8"
...
remove_if_expect "$uut_name" ipv6 4453 "$uut_if" "no authentication mode" "authentication mode md5"
...
remove_topology_expect "$uut_name" ipv6 4453 "no default-information in" "default-information in"
remove_topology_expect "$uut_name" ipv6 4453 "no default-metric 11000 110 254 2 1492" "default-metric 11000 110 254 2 1492"
remove_topology_expect "$uut_name" ipv6 4453 "no distance eigrp" "distance eigrp 92 172"
remove_topology_expect "$uut_name" ipv6 4453 "no maximum-prefix" "maximum-prefix 1001"
remove_af_expect "$uut_name" ipv6 4453 "no metric weights" "metric weights 0 3 0 3 0 0 6"
remove_topology_expect "$uut_name" ipv6 4453 "no redistribute connected" "redistribute connected metric 11000 110 254 2 1492"
...
remove_topology_expect "$uut_name" ipv6 4453 "no variance" "variance 3"
vty_apply "configure terminal" "router eigrp $uut_name" \

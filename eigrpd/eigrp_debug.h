...
/* Host-notification debug flags. */
extern unsigned long term_debug_eigrp_notifications;
extern unsigned long conf_debug_eigrp_notifications;
...
extern const char *eigrp_debug_packet_category_cli_name(
	eigrp_debug_packet_category_t category);
...
extern void eigrp_debug_header_dump(const eigrp_header_t *header);


#endif /* _EIGRP_DEBUG_H_ */

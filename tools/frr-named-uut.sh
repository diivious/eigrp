...
# retained value; the concrete interface carries the rest of the interface
# command surface.
...
set_topology_expect "$uut_name" ipv6 4453 "metric weights 0 2 0 2 0 0"
...
set_topology_expect "$uut_name" ipv6 4453 "metric weights 0 3 0 3 0 0"
config="$(show_run)"
assert_mode_line_absent_in "$config" "$uut_name" ipv6 4453 "topology base" "exit-af-topology" "metric weights 0 2 0 2 0 0"
...
remove_if_expect "$uut_name" ipv6 4453 "$uut_if" "no authentication key-chain" "authentication key-chain EIGRP-UUT6-4453"
...
remove_topology_expect "$uut_name" ipv6 4453 "no metric weights" "metric weights 0 3 0 3 0 0"
